...
for t in $@; do
  ...
  if [ -e "${t}.sh" ] ; then
    ...
    . ${t}.sh && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /media/D/f/my/rust/substrate-node-template/target/debug/build/tikv-jemalloc-sys-84e789fe9c2fdb82/out/build/ /media/D/f/my/rust/substrate-node-template/target/debug/build/tikv-jemalloc-sys-84e789fe9c2fdb82/out/build/
  else
    export MALLOC_CONF= && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /media/D/f/my/rust/substrate-node-template/target/debug/build/tikv-jemalloc-sys-84e789fe9c2fdb82/out/build/ /media/D/f/my/rust/substrate-node-template/target/debug/build/tikv-jemalloc-sys-84e789fe9c2fdb82/out/build/
