...
for t in $@; do
  ...
  if [ -e "${t}.sh" ] ; then
    ...
    . ${t}.sh && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /media/D/f/my/rust/substrate-node-template/target/release/build/tikv-jemalloc-sys-a997642a97ee0ce3/out/build/ /media/D/f/my/rust/substrate-node-template/target/release/build/tikv-jemalloc-sys-a997642a97ee0ce3/out/build/
  else
    export MALLOC_CONF= && \
    export_malloc_conf && \
    $JEMALLOC_TEST_PREFIX ${t} /media/D/f/my/rust/substrate-node-template/target/release/build/tikv-jemalloc-sys-a997642a97ee0ce3/out/build/ /media/D/f/my/rust/substrate-node-template/target/release/build/tikv-jemalloc-sys-a997642a97ee0ce3/out/build/
